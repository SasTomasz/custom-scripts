...
# Max weights
fig.add_trace(go.Scatter(x=df.index, y=df["max_weight_1"], mode="lines+markers", name="max_weight_1"))
fig.add_trace(go.Scatter(x=df.index, y=df["max_weight_2"], mode="lines+markers", name="max_weight_2"))

# Min weights
fig.add_trace(go.Scatter(x=df.index, y=df["min_weight_1"], mode="lines+markers", name="min_weight_1"))
fig.add_trace(go.Scatter(x=df.index, y=df["min_weight_2"], mode="lines+markers", name="min_weight_2"))

# Layout
fig.update_layout(
    title="Min & Max Weights Over Time",
    xaxis_title="Time",
